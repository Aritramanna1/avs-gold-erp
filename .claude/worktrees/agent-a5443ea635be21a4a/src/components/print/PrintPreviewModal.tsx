    ...
    if (isDesktop && printUrl && iframeRef.current?.contentDocument) {
      try {
        ...
        const desktop = (window as unknown as {
          mtjDesktop: { print: { printHtml: (h: string, o?: any) => Promise<{ success: boolean; error?: string }> } };
        }).mtjDesktop;
        ...
        <DialogHeader className="pb-2 border-b">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <Tabs
              ...
              className="w-auto"
            >
              <TabsList className="grid grid-cols-3 h-8 w-72 text-xs">
                <TabsTrigger value="archival">Archival (A4)</TabsTrigger>
                <TabsTrigger value="thermal">Thermal (Roll)</TabsTrigger>
                <TabsTrigger value="tag">Jewellery (Tag)</TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            <div className="flex items-center gap-2">
              {printMode === "archival" && (
                <Select value={orientation} onValueChange={(v) => setOrientation(v as "portrait" | "landscape")}>
                  <SelectTrigger className="h-8 w-28 text-xs" data-testid="print-orientation-select">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <Select value={String(marginMm)} onValueChange={(v) => setMarginMm(Number(v))}>
                <SelectTrigger className="h-8 w-32 text-xs" data-testid="print-margin-select">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            {isDesktop && (
              <div className="flex items-center gap-2" data-testid="print-desktop-controls">
                <Select value={selectedPrinter} onValueChange={setSelectedPrinter}>
                  <SelectTrigger className="h-8 w-44 text-xs" data-testid="print-printer-select">
