        ...
        <div class="container">
          ...
          <div class="footer">
            ...
            <p class="footer-text" style="font-style: italic;">
              This is an automated delivery communication. All metals and stones are weighed and registered under rigorous MTJ security audits.
            </p>
            <p class="socials">Powered by Areva VentureSphere ERP (AVS ERP)</p>
          </div>
        </div>
      </body>
    </html>
