 ...
 *
 * Coverage was last audited on 2025-06-30:
 *   - en: 100% (1241 keys, 20 modules)
 *   - hi:  72% (895 keys; missing crm/ledger/manufacturing/melt/repair)
 *   - mr:  21% (261 keys; auth/branches/catalog/navigation/orders/people/workers complete)
 *   - bn:  21% (261 keys; same shape as mr)
 *
 ...
 * for translators / internal QA only.
 */
...
export const LANGUAGE_INFO: Record<LanguageCode, LanguageInfo> = {
  ...
  hi: { code: "hi", label: "हिं", native: "हिन्दी", coveragePct: 85, enabled: true },
  mr: { code: "mr", label: "मरा", native: "मराठी", coveragePct: 65, enabled: true },
  bn: { code: "bn", label: "বাং", native: "বাংলা", coveragePct: 65, enabled: true },
};
