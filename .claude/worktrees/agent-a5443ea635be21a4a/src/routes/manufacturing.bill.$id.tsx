...
export const Route = createFileRoute("/manufacturing/bill/$id")({
  head: () => ({ meta: [{ title: "Manufacturing Bill · MTJ ERP" }] }),
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "3mm" }}>
            ...
            <GoldStat label="Wastage" value={`${MG_TO_G(bill.actualWastageFineMg)} g`} sub={`${bill.actualWastagePct.toFixed(2)}%`} />
...
function GoldStat({
  ...
  return (
    <div>
      <div style={{ fontSize: "6.5pt", textTransform: "uppercase", letterSpacing: "0.3mm", color: "#555" }}>
        {label}
      </div>
