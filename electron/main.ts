...
app.commandLine.appendSwitch("enable-blink-features", "BarcodeDetection");
...
function registerIpcHandlers(): void {
  ...
  handle(IPC.WASENDER_UPLOAD_MEDIA, (_e, args: WasenderUploadMediaArgs) =>
    wasenderUploadMedia(args),
  );
