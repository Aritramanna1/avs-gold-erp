...
| Symptom                                | Safe action                                                                                                   |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| App will not open                      | Confirm one instance only, restart Windows, retain app data, collect time/error details.                      |
| Offline screen mentions Supabase/cloud | Capture the screen and mode; do not enter cloud credentials. Report as a defect.                              |
| Hybrid not syncing                     | Confirm internet, schema guard, Project URL/anon key, then inspect queue/conflicts. Do not delete local data. |
| Printer missing                        | Check Windows printer installation, then refresh Hardware/Print setup.                                        |
