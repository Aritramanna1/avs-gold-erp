...
Appitsoft Jewel ERP is a premium, modern cloud-native jewellery management platform. It uses a high-performance SPA (Single Page Application) frontend with real-time analytics dashboards, branch-wise rate-cut structures, HUID tracking, and multi-mode financial integrations.

This audit report reverse-engineers its functional footprint, navigation structures, mathematical formulas, and double-entry ledger postings to serve as a design guide for the **Ornexa (AVS Gold ERP)** platform.
