<?php
/**
 * AVS Gold ERP — Hostinger Email Configuration Endpoint
 *
 * GET /api/email/config.php  -> Returns safe public status (no plaintext password)
 * POST /api/email/config.php -> Saves credentials to encrypted server-side vault
 */
