...
$SUPABASE_URL = getenv('VITE_SUPABASE_URL') ?: (getenv('SUPABASE_URL') ?: 'https://mtj-erp.supabase.co');
$SUPABASE_ANON_KEY = getenv('VITE_SUPABASE_ANON_KEY') ?: getenv('SUPABASE_ANON_KEY');
