...
$SUPABASE_URL = getenv('SUPABASE_URL') ?: (getenv('VITE_SUPABASE_URL') ?: 'https://dqgrrafuoxaorvyrcuuh.supabase.co');
$SUPABASE_ANON_KEY = getenv('SUPABASE_ANON_KEY') ?: (getenv('VITE_SUPABASE_PUBLISHABLE_KEY') ?: 'sb_publishable_nJNeQ0ZIit5jFjK-J2qCMA_wvs8llEN');
