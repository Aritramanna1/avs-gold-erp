...
export interface FirmProfile {
  ...
  /** MTG edition: show Manubook nav link (default OFF). */
...
const DEFAULTS: Omit<SettingsState, keyof Functions> = {
  firm: {
    ...
    phone: "9830012345",
    email: "contact@maatarajewellers.shop",
    address: "12 Bowbazar Street, Kolkata",
    cityState: "Kolkata, West Bengal",
    gstin: "19AAACS1234L1Z9",
    footerLine: "Thank you for shopping with Maa Tara Jewellers.",
    terms: "Goods once sold will not be taken back. Subject to Kolkata jurisdiction.",
