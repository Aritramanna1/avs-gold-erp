...
export function getResolvedConfig() {
  ...
  if (resolvedUrl.includes("xrvsvzfqjptzbxjscnvf") || resolvedUrl.includes("vqsrdemjiehzykexkcwo")) {
...
function createSupabaseClient() {
  ...
  const supabaseUrl = configUrl || "https://vqsrdemjiehzykexkcwo.supabase.co";
