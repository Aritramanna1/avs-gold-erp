...
const MTG_ACTIONS: MtgAction[] = [
  ...
  { to: "/workshop/gold-book", label: "ISSUE", icon: ArrowUpRight, feature: "manufacturing" },
  { to: "/workshop/gold-book", label: "RECEIVE", icon: ArrowDownLeft, feature: "manufacturing" },
  { to: "/melt", label: "MELT", icon: FlameKindling, feature: "melt_account" },
  { to: "/workshop", label: "POLISH", icon: Sparkles, feature: "manufacturing" },
  {
    to: "/people",
    label: "KARIGAR",
    icon: Hammer,
