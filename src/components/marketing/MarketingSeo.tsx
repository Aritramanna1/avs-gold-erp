...
export function MarketingSeo({
  ...
  const desc =
    description ??
    "Ornexa is a manufacturing-first jewellery ERP with gold custody, karigar management, GST billing, and portals. Access is by authorized invitation.";
  ...
  useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      offers: {
        ...
        price: "0",
        priceCurrency: "INR",
        description: "Authorized invitation required",
      },
      publisher: {
        "@type": "Organization",
