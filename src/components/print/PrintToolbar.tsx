...
import { Printer, ArrowLeft, Download, Loader2, Settings2, RotateCcw, Share2 } from "lucide-react";
...
export function PrintToolbar({
  ...
  const [sharingLocal, setSharing] = useState(false);
  const sharing = sharingProp ?? sharingLocal;
            ...
            <Button
              ...
              onClick={() => {
                void (async () => {
                  ...
                  setSharing(true);
                  try {
                    toast.error("Share this document from Print preview after the PDF is generated.");
                  } finally {
                    setSharing(false);
                  }
                })();
