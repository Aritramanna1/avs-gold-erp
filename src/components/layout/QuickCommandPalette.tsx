...
interface CommandItem {
  id: string;
  title: string;
  category: "Retail" | "Stock" | "Manufacturing" | "Accounts" | "Payroll" | "Reports" | "Settings";
  to: string;
...
const COMMANDS: CommandItem[] = [
  ...
  },
  {
    ...
    icon: <Package className="h-4 w-4 text-indigo-400" />,
  ...
  {
    id: "attendance_sheet",
    title: "Staff Attendance & Daily Register",
    category: "Payroll",
    to: "/attendance",
  ...
  },
  {
    ...
    title: "GST Returns & GSTR-1 / GSTR-3B Summary",
    category: "Reports",
