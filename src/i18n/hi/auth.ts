const translations = {
  ...
  resetHeader: "पासवर्ड भूल गए",
  resetPlaceholder: "you@example.com",
  resetBtn: "ओटीपी भेजें",
  resetOtpHint: "हम आपके ईमेल पर 6 अंकों का कोड भेजेंगे। नया पासवर्ड सेट करने के लिए उसे दर्ज करें।",
  ...
  publicSignupDisabled:
    "नई वर्कशॉप? 14-दिन का ट्रायल शुरू करें। किसी फर्म में जुड़ रहे हैं? अपने जौहरी का आमंत्रण स्वीकार करें।",
