...
const AUDIENCE_HINTS: Record<LoginAudience, string> = {
  staff:
    "Workshop owners and staff: sign in above with email or Google. New firm? Request access. Joining a firm? Accept invitation.",
  customer:
  ...
  karigar:
    "Karigar portal: accept the firm's invitation, then sign in with Google or password. Role and gold jobs come from the invite — not from picking a button.",
  supplier:
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          >
            ...
            <p className="text-[11px] leading-relaxed text-white/65">
              ...
              first — the invite assigns your role. One Google account cannot open another
              jeweller&apos;s workshop.
            </p>
            ...
            <button
              ...
              className="w-full rounded-sm border border-white/20 px-3 py-2.5 text-sm font-semibold text-white/90"
