 ...
 * Karigar workers authenticate via email OTP.
...
import { Hammer, ArrowLeft, CheckCircle2, Loader2, Mail } from "lucide-react";
          ...
          {!sent ? (
            <form onSubmit={handleSend} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="karigar-email" className="block text-sm font-medium text-gray-700">
                  Email Address
                </label>
