...
import { triggerGlobalPrint } from "@/lib/print-engine";
...
function LedgerPage() {
  ...
  function handleCashPrint() {
    triggerGlobalPrint("/reports/book-print/cash_book", "Company Cash Ledger");
  }

  function handleGoldPrint() {
    triggerGlobalPrint("/reports/book-print/fine_rojmel", "Company Fine Gold Ledger");
  }
        ...
        <table className="w-full text-xs">
          <thead className="bg-muted/50 text-muted-foreground border-b text-[10px] uppercase font-mono tracking-wider">
            <tr>
              ...
              <th className="py-3 px-3 text-left whitespace-nowrap">Voucher No</th>
              <th className="py-3 px-4 text-left whitespace-nowrap">Party Name</th>
              <th className="py-3 px-3 text-left whitespace-nowrap">Type</th>
              <th className="py-3 px-4 text-left min-w-[180px]">Description</th>
              <th className="py-3 px-4 text-right whitespace-nowrap min-w-[120px]">Debit (Dr)</th>
              <th className="py-3 px-4 text-right whitespace-nowrap min-w-[120px]">Credit (Cr)</th>
              <th className="py-3 px-5 text-right font-bold whitespace-nowrap min-w-[140px]">Balance (₹)</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border/60">
            {rows.map((r) => (
              <tr key={r.id} className="hover:bg-muted/15 transition-colors">
                <td className="py-3 px-4 whitespace-nowrap font-mono text-muted-foreground">{r.date}</td>
                ...
                <td className="py-3 px-4 whitespace-nowrap font-medium text-foreground">{r.partyName}</td>
                ...
                <td className="py-3 px-4 max-w-[240px] break-words text-muted-foreground">{r.description}</td>
                <td className="py-3 px-4 text-right whitespace-nowrap font-mono">
                  {r.debitPaise ? <MoneyDisplay paise={r.debitPaise} className="text-destructive font-semibold" /> : <span className="text-muted-foreground/40">—</span>}
                </td>
                <td className="py-3 px-4 text-right whitespace-nowrap font-mono">
                  {r.creditPaise ? <MoneyDisplay paise={r.creditPaise} className="text-emerald-500 font-semibold" /> : <span className="text-muted-foreground/40">—</span>}
                </td>
                <td className="py-3 px-5 text-right whitespace-nowrap font-mono font-bold">
                  <MoneyDisplay paise={r.closingPaise} showCrDr />
                </td>
              </tr>
            ))}
          </tbody>
