...
function WorkerReportPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto print:p-4 print:max-w-none print:m-0 print:space-y-4 print:text-black">
      ...
      <div className="hidden print:block border-b-2 border-black/80 pb-3 mb-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right space-y-0.5">
            <h2 className="text-base font-bold text-black uppercase tracking-wider">Worker Report</h2>
            <p className="text-xs text-gray-600 font-medium">Per-Karigar Pending Gold & Settlement</p>
