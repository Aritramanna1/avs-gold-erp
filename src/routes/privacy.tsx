...
export const Route = createFileRoute("/privacy")({
  head: () => ({ meta: [{ title: "Privacy Policy · Ornexa ERP" }] }),
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:px-8 prose prose-sm dark:prose-invert max-w-none space-y-4 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            records). You may request export or deletion subject to legal holds — contact your firm
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Access, rectification, erasure, restriction, portability, and objection — contact{" "}
