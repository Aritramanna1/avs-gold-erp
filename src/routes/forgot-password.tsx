...
import { Mail, ArrowLeft, CheckCircle2, KeyRound, Loader2, Phone, ShieldAlert } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-8 relative overflow-hidden">
      ...
      <Card className="w-full max-w-sm p-6 space-y-4 border-border shadow-elegant bg-card/85 backdrop-blur-md relative z-10">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Reset your cloud account password</p>
        </div>
