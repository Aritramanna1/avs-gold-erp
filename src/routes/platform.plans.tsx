...
function PlatformPlanBuilderPage() {
  ...
  const [selectedTier, setSelectedTier] = useState<CommercialPlanTier>("avs_30k");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await publishPlanVersion({
        ...
        whatsappEligibility: selectedTier === "avs_10k" || selectedTier === "avs_mtg" ? "none" : "managed_limited",
        aiEligibility: selectedTier === "avs_50k",
        isPublished: true,
      });
      await supabase
        .from("platform_plans")
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    ...
                    {selectedTier === "avs_10k"
                      ? "Choose 1 surface (Web or Desktop, no mobile)"
                      : selectedTier === "avs_mtg"
                        ? "Choose 1 surface (Web or Mobile)"
                        : selectedTier === "avs_30k"
                          ? "Choose 2 surfaces"
