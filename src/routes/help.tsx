...
const FAQS = [
  {
    ...
    a: "Ornexa uses the standard formula: Fine Weight uses Fine mg = round(Gross mg × Purity / 999). For example, 10.000g of 916 gold equals exactly 9.160g of Fine Gold. Both the physical gross weight and pure fine gold balances are maintained simultaneously in real-time.",
  },
  {
