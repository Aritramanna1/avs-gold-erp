...
export const SYSTEM_KNOWLEDGE_ARTICLES: KnowledgeArticle[] = [
  {
    id: "faq_fine_gold",
    knowledgeTier: "industry",
    topic: "fine_gold",
    title: "What is Fine Gold?",
    language: "en-IN",
    summary:
...
In Ornexa, purity is always stored as an integer per-mille (e.g. 916, not 0.916). Touch is used to calculate fine gold weight and is snapshotted on every voucher so historical records remain accurate even if rates change.`,
  ...
  {
    id: "faq_gross_less_net_fine",
    knowledgeTier: "industry",
    topic: "weight_types",
    title: "Gross, Less, Net and Fine Weight Explained",
    language: "en-IN",
    summary:
      "Gross = total piece weight. Less = stone/other deductions. Net = gold-only weight. Fine = pure gold content at touch.",
    content: `**Gross Weight:** Total weight of the piece including stones, findings, and any attachments. Weighed on scale.
...
In billing and manufacturing, making charges may be calculated on Gross or Net depending on your configured rules. Ornexa snapshots which basis was used on each voucher.`,
    ...
    aliases: ["gross wt", "net wt", "less wt", "fine wt"],
  ...
  {
    id: "faq_karat_purities",
    knowledgeTier: "india",
    topic: "karat_standards",
    title: "What is 22K / 18K / 14K?",
    language: "en-IN",
    summary:
      "Karat indicates gold purity: 22K = 916 touch (91.6%), 18K = 750 (75%), 14K = 585 (58.5%). Indian trade standard for jewellery is 22K.",
    content: `**22K (916 touch):** The Indian jewellery industry standard. 91.6% pure gold alloyed with copper/silver for durability. BIS hallmark for 22K shows 916.
...
Ornexa stores all purities as integer per-mille. When you enter "22K", the system resolves to touch 916 automatically.`,
  ...
  {
    id: "faq_customer_gold",
    knowledgeTier: "industry",
    topic: "customer_gold",
    title: "What is Customer Gold?",
    language: "en-IN",
    summary:
      "Metal deposited by a customer (old ornaments, advance bullion) held in custody. Creates a liability until settled or used against an order.",
    content: `**Customer Gold** (also called Customer Metal Deposit or Old Gold Advance) is physical gold received from a customer and held in your vault on their behalf.
...
In Ornexa, customer gold deposits are tracked separately from company-owned vault stock. Use People → Party 360 or the Gold Book to view customer metal balances.`,
    ...
    aliases: ["cust gold", "party gold", "jama sona", "customer jama"],
  ...
  {
    id: "faq_gold_payable_receivable",
    knowledgeTier: "industry",
    topic: "gold_balances",
    title: "Gold Payable and Gold Receivable",
    language: "en-IN",
    summary:
      "Gold Receivable = metal owed TO you. Gold Payable = metal you owe TO a party (customer deposit, karigar return pending, supplier advance).",
    content: `**Gold Receivable:** Fine gold that a party owes to your firm. Example: Karigar has not yet returned issued metal; customer owes metal against an advance order.
...
View firm-wide gold exposure in Reports → Gold Summary. View party-specific balances in People → Party 360 or ask the Assistant for a specific party's gold balance.`,
    ...
    aliases: ["sona udhar", "gold udhar", "metal receivable"],
    sourceDoc: "ORNEXA_DATA_AND_LEDGER_MODEL.md",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
  },
  {
    id: "faq_karigar_gold",
    knowledgeTier: "industry",
    topic: "karigar_custody",
    title: "What does Gold with Karigar mean?",
    language: "en-IN",
    summary:
...
Ask the Assistant "show [karigar name] gold balance" to see live custody from the ERP database. The Assistant reads actual ledger data — it never guesses balances.`,
    keywords: [
      "karigar gold",
      "worker gold",
      "gold with karigar",
    ...
    aliases: ["karigar ka sona", "worker custody", "gold at karigar"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/workshop/gold-book",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
  ...
  },
  {
    ...
    knowledgeTier: "industry",
    topic: "wastage",
    title: "What is Wastage (Ghat)?",
    language: "en-IN",
    summary:
      "Allowed metal loss during manufacturing (filing, melting, polishing). Excess beyond agreed allowance is charged to karigar or written off.",
    content: `**Wastage** (Ghat in Indian trade) is the metal lost during manufacturing processes — filing dust, melting loss, polishing loss, and chain-making waste.
...
Ornexa calculates wastage at receive time by comparing issued fine gold vs returned fine gold + scrap. Configure allowed wastage rules in Customization → Calculations.`,
  ...
  },
  {
    ...
    language: "en-IN",
    summary:
      "Metal recovered from filing dust, polishing scrap, and process waste — re-melted and returned to vault stock.",
    content: `**Recovery** is the process of collecting and re-processing metal waste (filing dust, buffing dust, broken links) back into usable bullion or scrap stock.
...
Track recovery in Workshop → Receive Metal and Melt/Conversion modules. Recovery percentage is a key KPI in manufacturing reconciliation reports.`,
    keywords: ["recovery", "scrap recovery", "filing recovery", "dust recovery", "polish recovery"],
    aliases: ["scrap return", "dust collection", "recovery percent"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/melt",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
  ...
  },
  {
    ...
    knowledgeTier: "industry",
    topic: "refining",
    title: "What is Refining?",
    language: "en-IN",
    summary:
      "Converting scrap/old gold into high-purity bullion bars through melting, cupellation, or fire assay at a refinery.",
    content: `**Refining** is the process of purifying impure gold (old ornaments, filing scrap, mixed alloys) into standard purity bars (typically 999 fine).
...
In Ornexa, record refinery transactions via Supplier Purchases, Melt Jobs, or Metal Conversion. Track refinery parties in People with type Refinery.`,
  ...
  {
    id: "faq_hallmark_huid",
    knowledgeTier: "india",
    topic: "hallmarking",
    title: "Hallmarking and HUID Explained",
    language: "en-IN",
    summary:
      "BIS hallmark certifies gold purity. HUID (Hallmark Unique ID) is a 6-character alphanumeric code laser-marked on each piece since July 2021.",
...
The Assistant will never invent or alter HUID codes — these are protected identifiers.`,
    keywords: ["hallmark", "huid", "bis", "hallmarking", "purity certificate", "assay mark"],
    aliases: ["halmark", "hall mark", "bis hallmark", "huid code"],
    sourceDoc: "TAGGING_AND_TRACEABILITY_MASTER.md",
    relatedRoute: "/stock/hallmark",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
  },
  {
    ...
    content: `**Gold Issue (Metal Issue Slip):**
...
Both operations are atomic ledger postings. The Assistant can draft an Issue slip but requires your confirmation before posting (Risk Level 3).`,
    keywords: [
      "gold issue",
      "gold receive",
      "issue gold",
    ...
    aliases: ["isshu gold", "recive gold", "issue metal", "receive metal"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/workshop/gold-book",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
  ...
  {
    id: "faq_metal_conversion",
    knowledgeTier: "product",
    topic: "metal_conversion",
    title: "How does Metal Conversion work?",
    language: "en-IN",
    summary:
...
Ownership separation: Customer-owned metal in custody can be converted while liability remains active until settlement.`,
    keywords: [
      "metal conversion",
      "alloy",
      "melt",
    ...
    aliases: ["dhalai", "melt conversion", "alloy addition"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/conversion",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
  ...
  },
  {
    ...
    knowledgeTier: "product",
    topic: "gold_book",
    title: "What is a Gold Book?",
    language: "en-IN",
    summary:
      "The Gold Book is the karigar/worker metal custody ledger — tracks all gold issued to and received from each artisan.",
    content: `The **Gold Book** (Karigar Gold Book / Worker Book) is the manufacturing metal ledger for each karigar:
...
Access via Workshop → Gold Book (/workshop/gold-book) or individual Worker Books. Ask the Assistant "show [name] gold book" for live balances from the database.`,
    keywords: ["gold book", "karigar book", "worker book", "metal book", "custody ledger"],
    aliases: ["sona ki kitab", "karigar khata"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/workshop/gold-book",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
...
Navigate to Workshop → Worker Books → select karigar. Each outside worker (Mina, Polish) also has a dedicated book.`,
    keywords: ["karigar book", "worker book", "artisan ledger", "bench book"],
    aliases: ["karigar khata", "worker ledger"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/workshop/worker-books",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
  },
  {
    ...
    knowledgeTier: "industry",
    topic: "party_ledger",
    title: "What is Party Ledger?",
    language: "en-IN",
    summary:
      "Complete financial and metal transaction history for a customer, supplier, or karigar — the Khata.",
    content: `**Party Ledger** (Khata) is the running account of all transactions with a business party:
...
In Ornexa, open People → select party → Ledger tab. The Assistant can fetch live party balances but never invents figures — always from the authoritative database.`,
  ...
  {
    id: "faq_opening_balance",
    knowledgeTier: "industry",
    topic: "opening_balance",
    title: "What is Opening Balance?",
    language: "en-IN",
    summary:
...
Opening balances post as special voucher types (opening_vault, opening_cash) and are included in reconciliation reports. Never edit opening balances after period lock without authorization.`,
    keywords: ["opening balance", "opening stock", "opening gold", "migration", "opening cash"],
    aliases: ["shuruati balance", "opening bal", "ob"],
    sourceDoc: "OPENING_BALANCE_AND_MIGRATION_MASTER.md",
    relatedRoute: "/control/migration",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
  ...
  {
    id: "faq_customer_gold_settlement",
    knowledgeTier: "product",
    topic: "customer_settlement",
    title: "How is Customer Gold Settled?",
    language: "en-IN",
    summary:
      "Customer gold is settled by returning metal, adjusting against a new order/invoice, or converting to cash credit at agreed Bhav.",
    content: `**Customer Gold Settlement** closes the metal liability to a customer:
...
In Ornexa: Settlement module (/settlement) or Billing → Gold Settlement. The settlement voucher posts metal liability reduction and creates audit trail. Ask the Assistant about settlement workflow but verify actual balances from live data.`,
    ...
    aliases: ["sona settle", "gold hisab", "customer settlement"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
    relatedRoute: "/settlement",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
...
You can also ask the Assistant "create a customer" to start a guided draft flow.`,
    keywords: ["create customer", "add customer", "new party", "add karigar", "new supplier"],
    aliases: ["costomer create", "add party", "new customer"],
    sourceDoc: "PARTY_360_MASTER.md",
    relatedRoute: "/people",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
...
Ask the Assistant "create an order" for a guided draft, or say "show overdue orders" for live production queue.`,
    keywords: ["create order", "new order", "manufacturing order", "custom order"],
    sourceDoc: "WORKFLOW_MASTER.md",
    relatedRoute: "/orders/new",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
...
The Assistant can search jobs by status, karigar, or due date using live ERP data.`,
    keywords: ["create job", "job card", "new job", "assign job", "manufacturing job"],
    sourceDoc: "MANUFACTURING_LEDGER_MASTER.md",
...
Ask the Assistant "create invoice for [customer]" to start a draft, or "search invoice [number]" for existing bills.`,
    keywords: ["create invoice", "new invoice", "billing", "tax invoice", "make bill"],
    aliases: ["invoce", "new bill", "generate invoice"],
    sourceDoc: "DOCUMENT_PRINTING_MASTER.md",
    relatedRoute: "/billing",
    version: "1.0.0",
    effectiveFrom: "2026-01-01",
    lastReviewedAt: "2026-08-15",
    isSystem: true,
  ...
  {
    id: "faq_old_gold_exchange",
    knowledgeTier: "india",
    topic: "old_gold",
    title: "Old Gold Exchange Concepts",
    language: "en-IN",
    summary:
      "Customer brings old ornaments; assessed for weight/purity, valued at Bhav, adjusted against new purchase.",
    content: `**Old Gold Exchange** (OG Purchase) is a common Indian retail and wholesale practice:
...
**I will never:** Invent balances, modify data without confirmation, or bypass permissions.`,
    keywords: ["assistant", "help", "what can you do", "capabilities", "features"],
    aliases: ["help me", "what do you do", "ornexa assistant"],
    sourceDoc: "ASSISTANT_MASTER.md",
