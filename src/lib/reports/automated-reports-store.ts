...
const DEFAULT_SCHEDULES: AutomatedReportSchedule[] = [
  {
    ...
    frequency: "daily",
    executionTime: "08:00",
    recipients: ["owner@maatarajewellers.shop"],
    format: "pdf",
    branchScope: "all",
    isEnabled: true,
  ...
  },
  {
    ...
    frequency: "weekly",
    executionTime: "20:00",
    recipients: ["accounts@maatarajewellers.shop"],
    format: "both",
    branchScope: "all",
    isEnabled: true,
  ...
  },
  {
    ...
    frequency: "weekly",
    executionTime: "09:00",
    recipients: ["workshop@maatarajewellers.shop"],
    format: "pdf",
    branchScope: "all",
    isEnabled: false,
    lastRunAt: null,
    ...
    (set, get) => ({
      ...
      saveSchedule: async (schedule) => {
        ...
        const newRecord: AutomatedReportSchedule = {
          ...
          recipients: schedule.recipients || ["owner@maatarajewellers.shop"],
