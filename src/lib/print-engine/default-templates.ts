...
const classicBusinessSections: SectionConfig[] = [
  ...
  },
  {
    type: "table",
    id: "items",
    title: "Schedule of Items & Fine Gold Conversion",
    rowsPath: "items",
    footerRowPath: "itemsTotals",
    columns: [
      { key: "photoUrl", header: "Photo", align: "center", width: 0.8, renderAs: "image", showIf: "hasItemPhotos" },
      { key: "description", header: "Item Description & Particulars", align: "left", width: 2.8 },
      { key: "metalKind", header: "Metal", align: "center", width: 0.7, showIf: "hasMetalKind" },
      { key: "pcs", header: "Pcs", align: "center", width: 0.5, showIf: "hasPcs" },
      { key: "grossWt", header: "Gross (g)", align: "right", width: 0.9 },
      { key: "lessWt", header: "Less (g)", align: "right", width: 0.8 },
      { key: "addWt", header: "Add (g)", align: "right", width: 0.8 },
      { key: "netWt", header: "Net (g)", align: "right", width: 0.9 },
      { key: "tanch", header: "Tanch", align: "right", width: 0.8 },
      { key: "wstg", header: "Wstg %", align: "right", width: 0.8 },
      { key: "fineWt", header: "Fine (g)", align: "right", width: 1.0 },
      { key: "rateLabel", header: "Rate / Basis", align: "right", width: 1.1 },
      ...
      [
        {
          ...
          columns: 1,
          fields: [
            { label: "Gold Valuation (Fine)", valuePath: "goldValueLabel" },
            { label: "Making / Labour", valuePath: "makingLabel" },
            { label: "Hallmark Charges", valuePath: "hallmarkLabel", showIf: "hasHallmarkCharges" },
            { label: "Stone Charges", valuePath: "stoneLabel", showIf: "hasStoneCharges" },
            { label: "Other Charges", valuePath: "otherLabel", showIf: "hasOtherCharges" },
            ...
            {
              label: "Ledger Credit (Excess)",
              valuePath: "excessLedgerCreditLabel",
              variant: "success",
              showIf: "hasExcessGold",
            },
          ],
        },
      ],
      ...
      [
        {
          ...
          fields: [
            ...
            { label: "Invoice Total", valuePath: "grandTotalLabel", emphasis: true },
          ],
        },
      ],
    ],
...
const denseLedgerSections: SectionConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "purity", header: "Purity", align: "center", width: 0.8 },
      { key: "goldIn", header: "Gold In", align: "right", width: 0.9 },
      { key: "goldOut", header: "Gold Out", align: "right", width: 0.9 },
      { key: "debit", header: "Debit (INR)", align: "right", width: 1 },
      { key: "credit", header: "Credit (INR)", align: "right", width: 1 },
      { key: "goldBal", header: "Gold Bal", align: "right", width: 1 },
      { key: "moneyBal", header: "Cash Bal (INR)", align: "right", width: 1.1 },
    ],
  },
  {
    type: "fieldGrid",
    ...
    fields: [
      ...
      { label: "Total Outstanding", valuePath: "closingOutstandingText", emphasis: true },
    ],
  },
  standardSignatures,
];
...
/** Short / Compact Karigar Passbook variant. */
const karigarCustodyShortTemplate = builtin({
  id: "karigar_custody_statement_short",
  docType: "karigar_custody_statement",
  name: "Short Karigar Passbook (Compact / A5)",
  family: "dense_ledger",
  paperSize: "a5",
  sections: [
    { type: "header", id: "header" },
    {
      ...
      columns: 3,
      fields: [
        { label: "Artisan", valuePath: "partyName", emphasis: true },
        { label: "Period", valuePath: "periodLabel" },
        { label: "Closing Bal", valuePath: "closingBalanceText", emphasis: true },
      ],
    },
    {
      type: "table",
      ...
      rowsPath: "entries",
      columns: [
        { key: "date", header: "Dt", align: "left", width: 0.8 },
        { key: "voucherNo", header: "Vchr", align: "left", width: 0.8 },
        { key: "particulars", header: "Particulars", align: "left", width: 2.4 },
        { key: "received", header: "Recv (g)", align: "right", width: 0.9 },
        { key: "issued", header: "Issue (g)", align: "right", width: 0.9 },
        { key: "balance", header: "Bal (g)", align: "right", width: 0.9 },
      ],
    },
    dualWorkshopSignatures,
  ],
...
const customerLedgerStatementTemplate = builtin({
  ...
  sections: [
    ...
    },
    {
      ...
      rowsPath: "entries",
      columns: [
        { key: "date", header: "Date", align: "left", width: 1.0 },
        { key: "voucherNo", header: "Ref / Voucher", align: "left", width: 1.1 },
        { key: "typeLabel", header: "Type", align: "center", width: 0.9, renderAs: "badge" },
        { key: "description", header: "Description", align: "left", width: 2.0 },
        { key: "purity", header: "Purity", align: "center", width: 0.8 },
        { key: "goldIn", header: "Gold In", align: "right", width: 1.0 },
        { key: "goldOut", header: "Gold Out", align: "right", width: 1.0 },
        { key: "debit", header: "Debit (INR)", align: "right", width: 1.1 },
        { key: "credit", header: "Credit (INR)", align: "right", width: 1.1 },
        { key: "goldBal", header: "Gold Bal", align: "right", width: 1.1 },
        { key: "moneyBal", header: "Cash Bal (INR)", align: "right", width: 1.2 },
      ],
    },
    {
      type: "table",
      id: "billWiseRecon",
      title: "Bill-Wise Invoice Reconciliation",
      rowsPath: "billWiseReconciliation",
      columns: [
        { key: "invoiceNo", header: "Invoice No", align: "left", width: 1.2 },
        { key: "date", header: "Date", align: "left", width: 1.0 },
        { key: "originalDue", header: "Original Due", align: "right", width: 1.2 },
        { key: "paymentsAllocated", header: "Payments / Allocations", align: "right", width: 1.3 },
        { key: "amountRemaining", header: "Amount Remaining", align: "right", width: 1.3 },
        { key: "status", header: "Status", align: "center", width: 1.0 },
      ],
    },
    {
      type: "fieldGrid",
...
/** Customer Pack — All Unpaid / Partially Paid Invoices. */
const customerUnpaidInvoicesTemplate = builtin({
  id: "default_customer_unpaid_invoices",
  docType: "customer_unpaid_invoices",
  name: "Customer Unpaid Invoices Statement (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header" },
    {
      ...
      fields: [
        ...
        { label: "Statement Date", valuePath: "statementDate" },
        { label: "Unpaid Bills Count", valuePath: "unpaidCountText", emphasis: true },
        { label: "Address", valuePath: "customerAddress", fullWidth: true, showIf: "hasAddress" },
      ],
    },
    {
      type: "table",
      id: "unpaidItemsSchedule",
      title: "Unpaid & Partially Settled Invoices Schedule",
      rowsPath: "items",
      columns: [
        { key: "invoiceNo", header: "Bill No", align: "left", width: 1.1 },
        { key: "invoiceDate", header: "Date", align: "left", width: 0.9 },
        { key: "description", header: "Item Description & Details", align: "left", width: 3.2 },
        { key: "grossWt", header: "Gross (g)", align: "right", width: 1.0 },
        { key: "netWt", header: "Net (g)", align: "right", width: 1.0 },
        { key: "tanchWstg", header: "Tanch + Wstg", align: "center", width: 1.4 },
        { key: "fineWt", header: "Fine (g)", align: "right", width: 1.1 },
        { key: "totalLabel", header: "Bill Total", align: "right", width: 1.2 },
        { key: "amountPaid", header: "Paid", align: "right", width: 1.1 },
        { key: "amountRemaining", header: "Due Outstanding", align: "right", width: 1.3 },
        { key: "status", header: "Status", align: "center", width: 0.8 },
      ],
    },
    {
      type: "fieldGrid",
      ...
      columns: 2,
      fields: [
        { label: "Total Outstanding Fine Gold", valuePath: "totalOutstandingGoldText", emphasis: true },
        { label: "Total Outstanding Cash Due", valuePath: "totalOutstandingCashText", emphasis: true },
        { label: "Summary", valuePath: "summaryStatement", fullWidth: true },
      ],
    },
    standardSignatures,
  ],
...
/** Customer Pack — All Fully Paid Invoices. */
const customerPaidInvoicesTemplate = builtin({
  id: "default_customer_paid_invoices",
  docType: "customer_paid_invoices",
  name: "Customer Fully Settled Invoices Statement (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header" },
    {
      ...
      fields: [
        ...
        { label: "Phone", valuePath: "customerPhone" },
        { label: "Statement Date", valuePath: "statementDate" },
        { label: "Settled Bills Count", valuePath: "paidCountText", emphasis: true },
        { label: "Address", valuePath: "customerAddress", fullWidth: true, showIf: "hasAddress" },
      ],
    },
    {
      type: "table",
      id: "paidItemsSchedule",
      title: "Fully Paid Invoices Schedule",
      rowsPath: "items",
      columns: [
        { key: "invoiceNo", header: "Bill No", align: "left", width: 1.1 },
        { key: "invoiceDate", header: "Bill Date", align: "left", width: 0.9 },
        { key: "paidDate", header: "Paid Date", align: "left", width: 1.0 },
        { key: "description", header: "Item Description & Details", align: "left", width: 3.2 },
        { key: "grossWt", header: "Gross (g)", align: "right", width: 1.0 },
        { key: "netWt", header: "Net (g)", align: "right", width: 1.0 },
        { key: "tanchWstg", header: "Tanch + Wstg", align: "center", width: 1.4 },
        { key: "fineWt", header: "Fine (g)", align: "right", width: 1.1 },
        { key: "totalLabel", header: "Amount Paid", align: "right", width: 1.2 },
        { key: "status", header: "Status", align: "center", width: 0.9 },
      ],
    },
    {
      type: "fieldGrid",
      ...
      columns: 2,
      fields: [
        { label: "Total Settled Fine Gold", valuePath: "totalPaidGoldText", emphasis: true },
        { label: "Total Settled Cash Value", valuePath: "totalPaidCashText", emphasis: true },
        { label: "Summary", valuePath: "summaryStatement", fullWidth: true },
      ],
    },
    standardSignatures,
...
/** Short / Compact Customer & Party Ledger variant. */
const customerLedgerShortTemplate = builtin({
  id: "customer_ledger_statement_short",
  docType: "customer_ledger_statement",
  name: "Short Ledger (Compact / Quick Print)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header" },
    {
      ...
      columns: 2,
      fields: [
        { label: "Customer / Party", valuePath: "customerName", emphasis: true },
        { label: "Phone / Contact", valuePath: "customerPhone" },
        { label: "Closing Fine Gold", valuePath: "closingGoldText", emphasis: true },
        { label: "Closing Net Cash", valuePath: "closingCashText", emphasis: true },
      ],
    },
    {
      type: "table",
      ...
      rowsPath: "entries",
      columns: [
        { key: "date", header: "Dt", align: "left", width: 0.9 },
        { key: "voucherNo", header: "Vchr", align: "left", width: 0.9 },
        { key: "description", header: "Particulars", align: "left", width: 2.0 },
        { key: "goldIn", header: "Fine In", align: "right", width: 1.0 },
        { key: "goldOut", header: "Fine Out", align: "right", width: 1.0 },
        { key: "debit", header: "Debit (INR)", align: "right", width: 1.1 },
        { key: "credit", header: "Credit (INR)", align: "right", width: 1.1 },
        { key: "moneyBal", header: "Bal (INR)", align: "right", width: 1.2 },
      ],
    },
    standardSignatures,
  ],
...
const homeSettlementSlipTemplate = builtin({
  id: "default_home_settlement_slip",
  docType: "home_settlement_slip",
  name: "Customer Settlement Statement (A4 / A5)",
  family: "traditional_indian",
  paperSize: "a4",
  sections: [
    standardHeader,
    partyCustomer,
    {
      type: "table",
      id: "items",
      title: "Settlement Ornaments & Materials",
      rowsPath: "items",
      columns: [
        { key: "description", header: "Particulars / Ornament", align: "left", width: 3 },
        { key: "purity", header: "Purity / Karat", align: "center", width: 1 },
        { key: "grossWt", header: "Gross (g)", align: "right", width: 1 },
        { key: "netWt", header: "Net (g)", align: "right", width: 1 },
        { key: "fineWt", header: "Fine Gold (g)", align: "right", width: 1 },
        { key: "pcs", header: "Qty", align: "center", width: 0.8 },
      ],
    },
    {
      type: "row",
      id: "settlementMovementRow",
      columnWidths: [1, 1],
      columns: [
        [
          {
            type: "fieldGrid",
            id: "goldMovementGrid",
            title: "Fine Gold Ledger Reconciliation",
            columns: 1,
            fields: [
              { label: "Previous Gold Balance", valuePath: "previousGoldBalance" },
              { label: "Fine Gold Used / Billed", valuePath: "goldSettledLabel", emphasis: true },
              { label: "Gold Received / Deposited", valuePath: "goldReceivedLabel" },
              { label: "Net Closing Gold Balance", valuePath: "closingGoldBalance", emphasis: true },
            ],
          },
        ],
        [
          {
            type: "fieldGrid",
            id: "cashMovementGrid",
            title: "Cash & Bhav Settlement",
            columns: 1,
            showIf: "hasCash",
            fields: [
              { label: "Reference Bhav / Rate", valuePath: "goldRateLabel" },
              { label: "Cash Amount Settled", valuePath: "cashSettledLabel", emphasis: true },
              { label: "Outstanding Cash Due", valuePath: "closingSettlementLabel", showIf: "hasBalance" },
              { label: "Settlement Status", valuePath: "settlementStatus", variant: "success" },
            ],
          },
        ],
      ],
...
const goldReceiveSlipTemplate = builtin({
  id: "default_gold_receive_slip",
  docType: "gold_receive_slip",
  name: "Artisan Gold Receive & Workmanship Slip (A4 / A5)",
  family: "manufacturing_workshop",
  paperSize: "a4",
  sections: [
    standardHeader,
    partyWorker,
    {
      ...
      columns: 3,
      fields: [
        { label: "Job Card No", valuePath: "jobNo", emphasis: true },
        { label: "Work Order No", valuePath: "orderNo" },
        { label: "Ornament Name", valuePath: "itemName" },
      ],
    },
    {
      type: "table",
      id: "returns",
      title: "Finished Goods & Returns Schedule",
      rowsPath: "returns",
      columns: [
        { key: "particulars", header: "Particulars", align: "left", width: 2 },
        { key: "net", header: "Weight (g)", align: "right", width: 1 },
        { key: "purity", header: "Purity", align: "center", width: 1 },
        { key: "fine", header: "Fine Gold (g)", align: "right", width: 1 },
        { key: "voucher", header: "Receipt No", align: "left", width: 1 },
        { key: "time", header: "Time", align: "center", width: 0.8 },
      ],
    },
    {
      type: "fieldGrid",
      id: "wastageLossGrid",
      title: "Wastage & Loss Verification",
      columns: 3,
      fields: [
        { label: "Allowed Wastage", valuePath: "expectedLoss" },
        { label: "Actual Loss", valuePath: "actualLoss" },
        { label: "Over-loss Penalty", valuePath: "overloss", variant: "critical" },
      ],
    },
    { type: "richText", id: "notes", title: "Remarks & Quality Notes", textPath: "notes", showIf: "hasNotes" },
    dualWorkshopSignatures,
  ],
});
  ...
  sections: [
    ...
    partyCustomer,
    {
      ...
      fields: [
        ...
        { label: "Cash Settled", valuePath: "cashSettledLabel", emphasis: true, showIf: "hasCash" },
        { label: "Settlement Basis / Rate", valuePath: "goldRateLabel" },
      ],
    },
    { type: "richText", id: "settlementNotes", title: "Settlement Memorandum", textPath: "notes" },
    standardSignatures,
...
/** Recovered CVsE73i6 dense-ledger shell for Fine Rojmel. */
const fineRojmelTemplate = builtin({
  id: "default_fine_rojmel_report",
  docType: "fine_rojmel",
  name: "Fine Rojmel (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    ...
    },
    {
      ...
      tableStyle: "classic",
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Voucher No", align: "left", width: 1.2 },
        { key: "c3", header: "Narration / Particulars", align: "left", width: 2.5 },
        { key: "c4", header: "Fine In (g)", align: "right", width: 1 },
        { key: "c5", header: "Fine Out (g)", align: "right", width: 1 },
        { key: "c6", header: "Balance Fine (g)", align: "right", width: 1.1 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Dar Rojmel. */
const darRojmelTemplate = builtin({
  id: "default_dar_rojmel_report",
  docType: "dar_rojmel",
  name: "Dar Rojmel (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    ...
    },
    {
      ...
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Voucher No", align: "left", width: 1.2 },
        { key: "c3", header: "Party & Narration", align: "left", width: 2.5 },
        { key: "c4", header: "Jama (₹)", align: "right", width: 1 },
        { key: "c5", header: "Nave (₹)", align: "right", width: 1 },
        { key: "c6", header: "Closing Cash (₹)", align: "right", width: 1.1 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Company Cash Book. */
const cashBookTemplate = builtin({
  id: "default_cash_book_report",
  docType: "cash_book",
  name: "Company Cash Book (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header", showQr: false },
    ...
    },
    {
      ...
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Voucher No", align: "left", width: 1.2 },
        { key: "c3", header: "Description / Party", align: "left", width: 2.5 },
        { key: "c4", header: "Debit / In (₹)", align: "right", width: 1 },
        { key: "c5", header: "Credit / Out (₹)", align: "right", width: 1 },
        { key: "c6", header: "Balance (₹)", align: "right", width: 1.1 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Karigar Book. */
const karigarBookTemplate = builtin({
  id: "default_karigar_book_report",
  docType: "karigar_book",
  name: "Karigar Book (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header", showQr: false },
    ...
    },
    {
      ...
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Entry No", align: "left", width: 1.2 },
        { key: "c3", header: "Artisan / Karigar", align: "left", width: 2.2 },
        { key: "c4", header: "Type", align: "center", width: 0.8 },
        { key: "c5", header: "Net Wt (g)", align: "right", width: 1 },
        { key: "c6", header: "Fine Wt (g)", align: "right", width: 1 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Barcode Stock. */
const barcodeStockTemplate = builtin({
  id: "default_barcode_stock_report",
  docType: "barcode_stock",
  name: "Barcode Stock Inventory (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header", showQr: false },
    ...
    },
    {
      ...
      tableStyle: "classic",
      columns: [
        { key: "c1", header: "Barcode / Item Code", align: "left", width: 1.5 },
        { key: "c2", header: "Item Description", align: "left", width: 2.5 },
        { key: "c3", header: "Purity", align: "center", width: 0.8 },
        { key: "c4", header: "Gross Wt (g)", align: "right", width: 1 },
        { key: "c5", header: "Net Wt (g)", align: "right", width: 1 },
        { key: "c6", header: "HUID / Tag Ref", align: "left", width: 1.2 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Item Jama Nave. */
const itemJamaNaveTemplate = builtin({
  id: "default_item_jama_nave_report",
  docType: "item_jama_nave",
  name: "Item Jama Nave Report (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header", showQr: false },
    ...
    },
    {
      ...
      tableStyle: "classic",
      columns: [
        { key: "c1", header: "Item / Account Name", align: "left", width: 2.2 },
        { key: "c2", header: "Sale Fine Wt", align: "right", width: 1 },
        { key: "c3", header: "Purchase Fine Wt", align: "right", width: 1 },
        { key: "c4", header: "Sale Amount (₹)", align: "right", width: 1.1 },
        { key: "c5", header: "Purchase Amount (₹)", align: "right", width: 1.1 },
        { key: "c6", header: "Txn Count", align: "center", width: 0.7 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 dense-ledger shell for Dhadi Book. */
const dhadiBookTemplate = builtin({
  id: "default_dhadi_book_report",
  docType: "dhadi_book",
  name: "Dhadi Book (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    ...
    },
    {
      ...
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Batch / Entry No", align: "left", width: 1.2 },
        { key: "c3", header: "Process Details / Artisan", align: "left", width: 2.2 },
        { key: "c4", header: "Type", align: "center", width: 0.8 },
        { key: "c5", header: "Net Wt (g)", align: "right", width: 1 },
        { key: "c6", header: "Fine Wt (g)", align: "right", width: 1 },
      ],
...
/** Recovered CVsE73i6 dense-ledger shell for Daily Summary. */
const dailyJewellerySummaryTemplate = builtin({
  id: "default_daily_jewellery_summary_report",
  docType: "daily_jewellery_summary",
  name: "Daily Summary Report (A4)",
  family: "dense_ledger",
  paperSize: "a4",
  sections: [
    { type: "header", id: "header", showQr: false },
    ...
    },
    {
      ...
      columns: [
        { key: "c1", header: "Date", align: "left", width: 1 },
        { key: "c2", header: "Gold In (g)", align: "right", width: 1 },
        { key: "c3", header: "Gold Out (g)", align: "right", width: 1 },
        { key: "c4", header: "Cash In (₹)", align: "right", width: 1.1 },
        { key: "c5", header: "Cash Out (₹)", align: "right", width: 1.1 },
        { key: "c6", header: "Sales Total (₹)", align: "right", width: 1.3 },
      ],
    },
  ],
});

/** Recovered CVsE73i6 account-balance offline layout (Jama/Nave columns). */
...
export const DEFAULT_TEMPLATES: Record<PrintDocType, PrintTemplate[]> = {
  ...
  karigar_custody_statement: [karigarCustodyStatementTemplate, karigarCustodyShortTemplate],
  worker_passbook: [karigarCustodyStatementTemplate, karigarCustodyShortTemplate],
  ...
  gold_settlement: [goldSettlementTemplate, homeSettlementSlipTemplate],
  settlement_draft: [homeSettlementSlipTemplate, goldSettlementTemplate],
  home_settlement_slip: [homeSettlementSlipTemplate, goldSettlementTemplate],
  repair_receipt: [repairReceiptTemplate],
  repair_delivery_slip: [repairReceiptTemplate],
  repair_invoice: [repairReceiptTemplate],
  customer_ledger_statement: [customerLedgerStatementTemplate, customerLedgerShortTemplate],
  customer_unpaid_invoices: [customerUnpaidInvoicesTemplate],
  customer_paid_invoices: [customerPaidInvoicesTemplate],
  ...
  gold_receive_slip: [goldReceiveSlipTemplate, dailyMaterialSlipTemplate],
  metal_conversion_slip: [goldSettlementTemplate],
  platform_tax_invoice: [
    builtin({
      id: "default_platform_tax_invoice",
      docType: "platform_tax_invoice",
      name: "Platform Tax Invoice (A4)",
      family: "compact_accounting",
      paperSize: "a4",
      sections: [
        {
          ...
          columns: 2,
          fields: [
            { label: "From", valuePath: "sellerName", emphasis: true },
            { label: "GSTIN", valuePath: "sellerGstin" },
            { label: "Address", valuePath: "sellerAddress", fullWidth: true },
            { label: "Email", valuePath: "sellerEmail" },
            { label: "Phone", valuePath: "sellerPhone" },
          ],
        },
        {
          type: "fieldGrid",
          ...
          columns: 2,
          fields: [
            { label: "Bill To", valuePath: "buyerName", emphasis: true },
            { label: "Buyer GSTIN", valuePath: "buyerGstin" },
            { label: "Buyer Address", valuePath: "buyerAddress", fullWidth: true },
          ],
        },
        {
          type: "fieldGrid",
          ...
          columns: 2,
          fields: [
            { label: "Document", valuePath: "documentType", emphasis: true },
            { label: "Number", valuePath: "documentNo", emphasis: true },
            { label: "Issued", valuePath: "issuedAt" },
            { label: "Due", valuePath: "dueAt" },
            { label: "Status", valuePath: "statusText" },
            { label: "GST Rate", valuePath: "gstRateText" },
          ],
        },
        {
          type: "table",
          ...
          columns: [
            ...
            { key: "hsn", header: "HSN", width: 1 },
            { key: "taxable", header: "Taxable", align: "right", width: 2 },
            { key: "tax", header: "Tax", align: "right", width: 2 },
            { key: "total", header: "Total", align: "right", width: 2 },
          ],
        },
        {
          type: "fieldGrid",
          ...
          columns: 2,
          fields: [
            { label: "Taxable", valuePath: "taxableLabel" },
            { label: "CGST", valuePath: "cgstLabel" },
            { label: "SGST", valuePath: "sgstLabel" },
            { label: "IGST", valuePath: "igstLabel" },
            { label: "GST Total", valuePath: "gstLabel" },
            { label: "Grand Total", valuePath: "totalLabel", emphasis: true },
            { label: "Paid", valuePath: "paidLabel" },
          ],
        },
        {
          type: "richText",
          id: "desc",
          title: "Narration",
          textPath: "descriptionText",
        },
        standardSignatures,
      ],
    }),
  ],
  // Jewellery-book / ledger report shells — recovered CVsE73i6 dense_ledger layouts.
  account_balance_report: [accountBalanceReportTemplate],
  cash_book: [cashBookTemplate],
  fine_rojmel: [fineRojmelTemplate],
  dar_rojmel: [darRojmelTemplate],
  karigar_book: [karigarBookTemplate],
  barcode_stock: [barcodeStockTemplate],
  item_jama_nave: [itemJamaNaveTemplate],
  dhadi_book: [dhadiBookTemplate],
  daily_jewellery_summary: [dailyJewellerySummaryTemplate],
};
