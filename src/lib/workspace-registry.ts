...
export const WORKSPACES: Record<string, WorkspaceDefinition> = {
  ...
  stock: {
    ...
    baseRoute: "/stock",
    items: [
      { id: "gold", title: "Gold", to: "/stock", search: { tab: "gold" }, description: "Fine g @995 by custody — default Stock landing" },
      { id: "ready_stock", title: "Ready", to: "/stock", search: { tab: "ready" }, badge: "F3", description: "Finished jewellery pieces" },
      { id: "lots", title: "Raw lots", to: "/stock/lots", description: "Wholesale bullion packets and raw stock" },
      { id: "stock_entry", title: "Tag piece", to: "/stock/entry", description: "Rapid barcode generation and tagging" },
      { id: "barcode_scanner", title: "Scan tag", to: "/workshop/barcode-scanner", description: "Instant camera and hardware barcode scan" },
      { id: "transfers", title: "Transfers", to: "/stock/transfers", description: "Branch-to-branch inventory movement" },
      { id: "boxes", title: "Branch trays", to: "/stock/boxes", description: "Physical showcase and safe trays" },
      { id: "stones", title: "Stones", to: "/stock/stones", description: "Diamonds, precious stones and carats" },
      { id: "hallmark", title: "Hallmark", to: "/stock/hallmark", description: "HUID verification and batch status" },
