...
const DEFAULT_TICKETS: ServiceRequestItem[] = [
  {
    ...
    createdBy: "owner@arivahly.in",
    assignedTo: "support@arivahly.in",
  ...
  },
  {
    ...
    createdBy: "manager@arivahly.in",
    assignedTo: "admin@arivahly.in",
    ...
    (set, get) => ({
      ...
      createTicket: async (ticketData) => {
        ...
        const newTicket: ServiceRequestItem = {
          ...
          createdBy: ticketData.createdBy || "admin@arivahly.in",
