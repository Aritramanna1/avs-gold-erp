...
export const PRINT_DOC_LABELS: Record<PrintDocType, string> = {
  ...
  metal_conversion_slip: "Metal Conversion Slip",
  platform_tax_invoice: "Platform Tax Invoice",
  account_balance_report: "Account Balance Report",
  cash_book: "Cash Book",
  fine_rojmel: "Fine Rojmel",
  dar_rojmel: "Dar Rojmel",
  karigar_book: "Karigar Book",
  barcode_stock: "Barcode Stock",
  item_jama_nave: "Item Jama Nave",
  dhadi_book: "Dhadi Book",
  daily_jewellery_summary: "Daily Jewellery Summary",
};
